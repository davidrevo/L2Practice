...
contract NFTSwap is IERC721Receiver {
    ...
    function list(address _nftAddr, uint256 _tokenId, uint256 _price) public {
        ...
        Order storage _order = orders[_nftAddr][_tokenId];  //设置NFT持有人和价格
    ...
    function purchase(address _nftAddr, uint256 _tokenId) public payable {
        Order storage _order = orders[_nftAddr][_tokenId];   // 取得Order  
        require(_order.price > 0, "Invalid Price");  // NFT价格大于0
        require(msg.value >= _order.price, "Not Enough ETH"); // 买家支付ETH大于等于NFT价格
        ...
        delete orders[_nftAddr][_tokenId];  // 删除Order

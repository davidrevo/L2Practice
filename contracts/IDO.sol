...
contract IDOToken is ERC20("AXS Token"), Ownable {
    // 定义公开的 IDO 价格，初始值为 0.1 ETH
    uint256 punlic idoPrice = 0.1 * 10 ** 18;
    ...
    function buyToken(uint256 amount) public {
        // 确保用户还未购买过
        require(!isBuy[msg.sender], "You have already bought tokens");
        // 确保购买量不超过最大限制
        require(amount <= maxBuyAmount, "Buy amount exceeds the maximum limit");
